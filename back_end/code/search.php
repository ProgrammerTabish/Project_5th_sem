  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <input class="form-control mr-sm-2" type="search" placeholder="Enter name of the Area" aria-label="Search">
          <input class="form-control mr-sm-2" type="search" placeholder="Type of the property" aria-label="Search">
          <input class="form-control mr-sm-2" type="search" placeholder="Property ULPIN" aria-label="Search">
